...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/SDx/2017.2/Vivado_HLS/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/SDx/2017.2/Vivado_HLS/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/SDx/2017.2/Vivado_HLS/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/SDx/2017.2/Vivado_HLS/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/SDx/2017.2/Vivado_HLS/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "macc_4d.autotvin.dat"
	set constFileTvOut       "macc_4d.autotvout.dat"
	set constFileHdlTvIn     "macc_4d.autohdltvin.dat"
	set constFileHdlTvOut    "macc_4d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
