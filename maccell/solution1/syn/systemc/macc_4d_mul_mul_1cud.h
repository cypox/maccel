...
#ifndef __macc_4d_mul_mul_1cud__HH__
#define __macc_4d_mul_mul_1cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(macc_4d_mul_mul_1cud) {
    ...
    SC_CTOR(macc_4d_mul_mul_1cud):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
