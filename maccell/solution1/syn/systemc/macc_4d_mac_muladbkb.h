...
#ifndef __macc_4d_mac_muladbkb__HH__
#define __macc_4d_mac_muladbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(macc_4d_mac_muladbkb) {
    ...
    SC_CTOR(macc_4d_mac_muladbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
